...
# Calling the rosservices
    ...
    def auto_set_mode(self):
        ...
        try:
            mission=rospy.ServiceProxy("/mavros/set_mode",mavros_msgs.srv.SetMode)
            mission(custom_mode="AUTO.MISSION")
        # and print fail message on failure
        except rospy.ServiceException as e:
            print("error on setting mission mode: %s"%e)
    ...
    def wpPush(self,index,wps):
        ...
        try:
            ...
            push_wp(start_index=index,waypoints=wps)
        # and print fail message on failure
        except rospy.ServiceException as e:
